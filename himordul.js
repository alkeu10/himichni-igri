const wordList = ["АРГОН", "АРСЕН", "АСТАТ", "БАРИЙ", "БЕРИЛ", "БОРАТ", "БРОМИ", "БУТАН", "ВАНАД", "ГАЛИЙ", 
  "ГЕЛИЙ", "ДЕКАН", "ЕТАНО", "ЕТЕРИ", "ИНДИЙ", "ИТРИЙ", "КАЛАЙ", "КАЛИЙ", "КЕТОН", "КЮРИЙ", 
  "ЛИТИЙ", "НИКЕЛ", "ОСМИЙ", "РАДИЙ", "РАДОН", "РОДИЙ", "СЕЛЕН", "ТАЛИЙ", "ТИТАН", "ТОРИЙ", 
  "ТУЛИЙ", "ЦЕЗИЙ", "ЦЕРИЙ", "ОКСИД", "ЙОНЕН", "БАЗЕН", "ГАЗОВ", "МЕТАЛ", "АКТИВ", "ТЕЧЕН", 
  "УТАЙК", "ФИЛТР", "ФУНИЯ", "БЮРЕТ", "ЕМАЙЛ", "ЛАЗЕР", "ОЗОНА", "ПИРИТ", "ГИПСА", "АХАТА", 
  "НЕОНА", "БОРЕН", "ЙОДНА", "ВОДЕН", "ПАРЕН", "КВАРЦ", "ХАЛИТ", "СПЛАВ", "СПИРТ", "МОЛАР", 
  "ТОПЪЛ", "СУХИЯ", "ЧИСТА", "ХИРАЛ", "МОЛЕН", "КИСЕЛ", "СУЛФО", "НИТРО", "ХИДРО", "ЕСТЕР", 
  "АМИНО", "ТИОЛО", "ПИРОЛ", "ФУРАН", "ЕНОЛИ", "ТИТРА", "МАГМА", "ОПАЛА", "КУПРИ", "РУБИН", 
  "ФЛУОР", "СЯРАТ", "УРАНА", "КОЛБА", "ТИГЕЛ", "ПИПЕТ", "МЕНЗУ", "АМИДИ", "ПЕПТИ", "ЛИПИД", 
  "ХИТИН", "АЦЕТО", "ФЕНОЛ", "АНИЛИ", "КСИЛЕ", "ТОЛУЕ", "БЕНЗЕ", "ГЛИКО", "ГЛЮКО", "АЛКАН", 
  "АЛКЕН", "АЛКИН", "ДИОНИ", "ФОСФО", "БРОМА", "МЕДТА", "ЦИНКА", "ХЛОРА", "ЖЕЛЯЗ", "ЗЛАТО",
  "ОЛОВО", "ПЛАТИ", "СИЛИЦ", "МАНГА", "КОБАЛ", "МЕДЕН", "БОРНИ", "ЙОДЕН", "АРЕНА", "СОЛЕН",
  "АЛУМИ", "ФОСФО", "ОКИСЛ", "РЕДУЦ", "КРИПТ", "КСЕНО", "РАДИО", "АЛКАЛ", "СЯРАТА", "АТОМА",];
